...
const NotFound: React.FC = () => {
    return (
        <div className="min-h-screen bg-gradient-to-r from-red-500 to-pink-700 flex flex-col items-center justify-center text-white">
            ...
            <Link to="/gsm" className="mt-8 px-6 py-3 bg-blue-600 hover:bg-blue-700 rounded-lg shadow-lg transition duration-300 ease-in-out transform hover:-translate-y-1">
                Back to Home
            </Link>
        </div>
    );
